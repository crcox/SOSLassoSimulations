function [ ModelTable, summary ] = UnivariateAnalysis_lme( AnnotatedData, ConditionIndex )
...
%   Detailed explanation goes here
    ...
    ModelTable.tstat = cellfun(@(x) x.Coefficients.tStat(2), ModelTable.lme);
    ModelTable.pval = cellfun(@(x) x.Coefficients.pValue(2), ModelTable.lme);
